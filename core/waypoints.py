...
def takeoff(alt):
    conn.mav.commandd_long_send(conn.target_system, conn.target_component,
...
def add_mission(index, enlem, boylam, alt):
    waypoints.add(mavutil.mavlink.MAVLink_mission_item_message(conn.target_system, conn.target_component,
                                                               index,
